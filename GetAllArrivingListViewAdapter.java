...
public class GetAllArrivingListViewAdapter extends BaseAdapter {
	...
	public GetAllArrivingListViewAdapter(ArrayList<Flight> FlightArray, Activity a)  //changed to accept arraylist
	{
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null){
			...
			convertView = inflater.inflate(R.layout.get_all_arriving_list_view_cell, null);
			cell = new ListCell();
